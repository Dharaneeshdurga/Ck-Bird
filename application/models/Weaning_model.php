...
class Weaning_model extends CI_Model
{
	public function get_weaning_history_dt($date,$to_date){
		...
		$this->db->select('count(*) as total_production');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('bird_status'=>'Production');
		$this->db->where($array_where);
		$this->db->where('status','3');
		//$this->db->where_not_in('move_production_date','0000-00-00'); 
		$this->db->where('branch_id',$branch_id);
		//$this->db->or_where('status','4');
		$records = $this->db->get()->result();
		$total_production = $records[0]->total_production;

		$this->db->select('count(*) as splay_leg');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Splay Leg');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Airbubble');
		$this->db->where($array_where);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Mortality');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','bird_status'=>'Sale');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Cured');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Yolk sac infection');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Obesity');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'E.coli infection');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Wry neck');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Aspiration Pneumonia');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Slow digestion');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Crop burn');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Crop injury');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Oesophageal injury');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Respiratory distress');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Dehydration');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Unabsorbed yolk sac');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Air in the crop');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Traumatic injury');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Stunted chick');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Reduced crop size');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Splayed leg');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Fungal infection');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		...
		$this->db->select('count(*) as parasitic_infection');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Parasitic infection');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		$parasitic_infection = $records[0]->parasitic_infection;

		$this->db->select('count(*) as nervous_incoordination');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Nervous incoordination');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		$nervous_incoordination = $records[0]->nervous_incoordination;

		$this->db->select('count(*) as bacterial_infection');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Bacterial infection');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		$bacterial_infection = $records[0]->bacterial_infection;

		$this->db->select('count(*) as viral_infection');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Viral infection');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		$viral_infection = $records[0]->viral_infection;

		$this->db->select('count(*) as nervous_coccidiosis');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Nervous Coccidiosis');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		$nervous_coccidiosis = $records[0]->nervous_coccidiosis;

		$this->db->select('count(*) as gout');
		$this->db->from('ckb_incubation');
		$condition = "created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
		$array_where = array('status'=>'3','health_status'=>'Gout');
		$this->db->where($array_where);
		$this->db->where('branch_id',$branch_id);
		//$this->db->where('status',1);
		$records = $this->db->get()->result();
		$gout = $records[0]->gout;
			...
			$data[] = array(
				...
				"nervous_incoordination" => $nervous_incoordination,
				"bacterial_infection" => $bacterial_infection,
				"viral_infection" => $viral_infection,
				"nervous_coccidiosis" => $nervous_coccidiosis,
				"gout" => $gout
	...
	public function get_stunded_after_birth($date,$to_date){
		...
		$this->db->join('ckb_weaning as p','i.auto_id = p.incub_id');
		$this->db->where('i.status',3);
		$this->db->where('i.branch_id',$branch_id);
		$condition = "i.created_on BETWEEN " . "'" . $date . "'" . " AND " . "'" . $to_date . "'";
		if ($date != '' && $to_date != ''  ) $this->db->where($condition);
	...
	public function get_weaning_historyView_dt($array_where,$date,$to_date,$status){
		$branch_id = $this->session->userdata('branch_id');
		$this->db->select(
	...
	public function verify_data_weaning_dt($postData,$date,$to_date)
	{
		$response = array();
	...
	//	$this->db->join('ckb_brooder as c', 'm.move_35_brooder = b.auto_id');
		...
		//	if($record->status == '2'){   // check the status and return the data
			...
			$view = '<a href="'.$action_url1.'" class="btn btn-pink text-center btn-xs waves-effect waves-light tooltips" data-trigger="hover"  data-placement="top" data-toggle="tooltip" title="View Weaning History"><i class="fa fa-eye" aria-hidden="true"></i></a>  ';

//$action = "";
$action = '<a href="'.$action_url2.'" target="_blank"><button class="btn btn-primary btn-xs waves-effect text-center waves-light tooltips"  data-placement="top" data-toggle="tooltip" id="update" title="Update weaning Details"><i class="fa fa-eject" aria-hidden="true"></i></button></a>  '; 
...
$moved_production_date	= $record->move_production_date;	
if($moved_production_date == "0000-00-00")	{
$action .= '<button  onclick="get_move_production('."'".$record->auto_id."'".');" class="btn btn-success btn-xs waves-effect waves-light tooltips"  data-placement="top" data-toggle="tooltip" id="move" title="Move to Production" style="margin-top:5px;"><i class="fa fa-exchange" aria-hidden="true"></i></button>  ';
}
else{
	$action .= '<button  onclick="get_move_production('."'".$record->auto_id."'".');" class="btn btn-success btn-xs waves-effect waves-light tooltips"  data-placement="top" data-toggle="tooltip" id="move" title="Move to Production" style="margin-top:5px;" disabled><i class="fa fa-exchange" aria-hidden="true"></i></button>  ';

}

			
$moved_weaning_date	= date("d-m-Y", strtotime($record->moved_weaning_date));
//$moved_production_date	= date("d-m-Y", strtotime($record->move_production_date));

if($moved_production_date == "0000-00-00")	{
	$moved_production_date	= "";		
}
else{
	$moved_production_date	= date("d-m-Y", strtotime($record->move_production_date));
}	
$action .= '<button  onclick="change_healthStatus('."'".$record->auto_id."'".');" class="btn btn-danger btn-xs waves-effect waves-light tooltips" data-placement="top" data-toggle="tooltip" id="" style="margin-top:5px;" title="change health status"><i class="fa fa-exchange" aria-hidden="true"></i></button>	<br><br>';		
// revert option


if($record->bird_status == "Production" || $record->bird_status == "Sale" ){
	$action .= '<button  onclick="revert_to_prewean('."'".$record->egg_no."'".');" class="btn btn-warning btn-xs waves-effect waves-light tooltips" data-placement="top" data-toggle="tooltip" id="" title="Revert" disabled><i class="fa fa-undo" aria-hidden="true"></i></button>';		

}
else{
	$action .= '<button id="revert_prewean" onclick="revert_to_prewean('."'".$record->egg_no."'".');" class="btn btn-warning btn-xs waves-effect waves-light tooltips" data-placement="top" data-toggle="tooltip" id="" title="Revert"><i class="fa fa-undo" aria-hidden="true"></i></button>';		

}
////
$health_status = '<button  onclick="change_healthStatus('."'".$record->auto_id."'".');" class="btn btn-success btn-xs waves-effect waves-light tooltips" data-placement="top" data-toggle="tooltip" id="" title="change health status"><i class="fa fa-exchange" aria-hidden="true"></i></button>	<br><br>';		

if($record->hatch_weight < $record->std_hatch_weight){
	$health_status .="Stunded By Birth,<br>";
}
$query = $this->db->get_where('ckb_weaning', array('incub_id' => $record->auto_id ));
$count = $query->num_rows();
if($count >0){
	$this->db->select('std_weight,act_weight');
	$this->db->from('ckb_weaning');
...
$data[] = array(
				...
				"moved_weaning_date" => $moved_weaning_date,
				"moved_production_date" => $moved_production_date,
				"weaning_ring_no" => $record->weaning_ring_no,
	...
	public function get_wean_data_byone($postData,$postData1){  // get preweaning history
		$response = array();
        ...
        //# Total number of records without filtering
		$this->db->select('count(*) as allcount');
		$this->db->from('ckb_weaning i');
		$this->db->where('incub_id',$wean_id);
		$this->db->where('branch_id',$branch_id);
	...
	//if($prewean_id == $record->incub_id ){
		$action = '  <button  onclick="feed_history_pop('."'".$record->incub_id."'".','."'".$created_on."'".');" class="btn btn-success btn-xs waves-effect waves-light tooltips" data-placement="top" data-toggle="tooltip" id="birdDeletebtn" data-original-title="Delete"><i class="fa fa-eye"></i></button>';
			$data[] = array(
				"id" => $record->id,
