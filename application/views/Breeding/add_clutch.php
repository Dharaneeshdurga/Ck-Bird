...
<html>
    ...
    <body class="fixed-left">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="aviary_name" name="aviary_name" class="form-control" value="" readonly>
                                                <input type="hidden" id="aviary_id" name="aviary_id" class="form-control" value="" readonly>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="cage"  class="form-control" name="cage" value=""readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="cage">Species*</label>
                                                <input type="text" id="species_name"  class="form-control" name="species_name" value="" readonly>
                                                <input type="hidden" id="species_id"  class="form-control" name="bird_species" value="" readonly>
        ...
        <script src="<?php echo asset_url();?>pro_js/breeding/add_clutch.js"></script>
        <script>
