...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> |Non Proven Details</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">Non Proven Details</h4>
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Proven/add_proven">Add Non Proven</a></li>
                                <li class="active">Non Proven Details</li>
                            </ol>
                        </div>
                    </div>
...
<div id="eggd-modal"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog"> 
                                        <div class="modal-content"> 
                                            ...
                                            <tbody>
                                               <tr>
                                               <td id="group_name">1</td>
                                               <td id="species">18-03-2021</td>
                                               <td id="avairy">0</td>
                                               </tr>
                                               <tr>
                                               <td id="group_name">2</td>
                                               <td id="species">20-03-2021</td>
                                               <td id="avairy">2</td>
                                               </tr>
                                               <tr>
                                               <td id="group_name">3</td>
                                               <td id="species">23-03-2021</td>
                                               <td id="avairy">3</td>
                                               </tr>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Non Proven Details</h3>
                                </div>
                                <div class="panel-body">
                                    <a href="<?php echo base_url(); ?>index.php/Breeding/add_nproven"><button
                                            class="btn btn-primary waves-effect waves-light">Add Non Proven</button></a>
                                            <div class="row">
                                            <div class="col-md-2">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" id="nproven_tb">
                                                    <thead>
                                                        <tr>
                                                        <th>#</th>
                                                            <th>Sno</th>
                                                            ...
                                                            <th>Bonding</th>
                                                            <th>Preening</th>
                                                            <th>Feeding Without Dominance</th>
                                                            <th>Food Sharing</th>
                                                            <th>Nest box introduce</th>
                                                            <th>Single bird nesting</th>
                                                            <th>Action</th>
                                                            <!--th>Double bird nesting</th-->
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/breeding/add_nproven.js"></script>
    <script src="<?php echo base_url();?>assets/pro_js/breeding/view_nonproven.js"></script>
