...
<div id="eggd-modal"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                ...
                                                <table class="table table-striped table-bordered" id="proven_tb">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>No of eggs in Broken<br>(eggno in clutch)</th>
                                                            <th>No of eggs in IF<br>(eggno in clutch)</th>
                                                            <th>No of eggs in DIS<br>(eggno in clutch)</th>
                                                            <th>No of eggs in Hatch<br>(eggno in clutch)</th>
                                                            <th>last date</th>
                                                            <th>First date</th>
                                                            <th>Clutch int</th>
                                                            <th>Average days bw eggs</th>
                                                            <th>Average Weight</th>
                                                            <th>Action</th>
                                                            <th>Incubation History</th>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/breeding/view_proven.js"></script>
