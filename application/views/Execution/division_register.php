...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Buisness Head</title>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Buisness Head</h3>
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                 ...
                                                 <?php  if (isset($team_result) && !empty($team_result)) { 
                                                         ...
                                                         <tr>
                                                          ...
                                                          <?php //if($val->status_division == "") { ?>
                                                           <td class="<?php if($val->status_change==1) { echo "danger"; } ?>">
                                                           <form name="head_register" id="head_register" action="<?php echo base_url('index.php/Execution/update_division_decision'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">

                                                           <input type="hidden" class="form-control" name="team_id" id="team_id" value="<?php echo $val->auto_id; ?>"/>

                                                           <select class="form-control" name="status_division" id="status_division">
															...
															<td class="<?php if($val->status_change==1) { echo "danger"; } ?>"><?php echo $status;
															 if($val->status_division !=""){
																echo "/" . $val->status_division;
															 }
															 ?>
														</td>
                                                     ...
                                                     <?php  
                                                        //   } // end status if
                                                        //   else{
                                                        //      echo '<td>'. $val->status_division.'</td>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
        ...
        <script type="text/javascript">
        $(document).ready(function () {
				var  page="division_register";
				
				if(page=="division_register"){
					$(".excecution_m").click();
