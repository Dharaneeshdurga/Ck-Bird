...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | View Sales History</title>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">View Sales History</h3>
                                        
                                    </div>
                                    <div class="panel-body">
                                    <form id="sales_update_form" method="post" autocomplete="false" action="<?php echo base_url()."index.php/Execution/get_sales_history"; ?>" nctype="multipart/form-data">
                                       ...
                                       <!--div class="col-md-2">
                                            <div class="form-group">
                                                           <label for="clutch_no">Select Month</label>
                                                   <select class="form-control" name="sp_month" id="sp_month">
                                       ...
                                       <div class="col-md-2">
                                            <div class="form-group">
                                                           <label for="clutch_no">Enter Year</label>
                                                           <input type="text" class="select2 form-control" id="sp_year" name="sp_year" value="<?php echo date('Y'); ?>" >
                                                       </div>
                                                   </div-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="sales_his" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php  if (isset($sale_history) && !empty($sale_history)) { 
                                                      $count = 0;
                                                   
                                                         foreach($sale_history as $val) { 
 ...
 if($month == '12'){
     ...
     ?>
                                                         ...
                                                         <tr>
                                                           ...
                                                           <td ><?php echo $val->sale_cost;?></td>
                                                           <td ><?php echo $val->discrep_value; ?></td>

                                                           <td ><?php echo $val->static_status; ?></td>
                                                         </tr>
                                                         
<?php }
}

 else if (isset($sale_history_bymonth) && !empty($sale_history_bymonth)) { 
   $count =0;
  foreach($sale_history_bymonth as $result) { 
 ...
 if($month == '12'){
  ...
  <tr>
    ...
    <td ><?php echo $result->sale_cost;?></td>
    <td ><?php echo $result->discrep_value; ?></td>

    <td ><?php echo $result->static_status; ?></td>
  </tr>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
  ...
  <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/jquery.dataTables.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/buttons.colVis.min.js"></script>
        ...
        <script type="text/javascript">
        $(document).ready(function () {
            var  page="sales_history";
				
				if(page=="sales_history"){
					$(".sales_m").click();
					$(".sales_history").addClass("active");
				}
