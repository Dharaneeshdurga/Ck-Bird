                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class ="row">
                                        <div class="col-md-4">
                                        <form id="datalog"  action="<?php echo base_url("index.php/Handfeeding/upload_datalog") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        if(isset($datalog_result) &&(!empty($datalog_result))){
                                                          $count = 0;
                                                            foreach($datalog_result as $val){
                                                                ...
                                                                <td><?php echo $date;?></td>
                                                                <td><a href="<?php echo base_url("index.php/Handfeeding/datalog_download/".$val->datalog); ?>">Download</a></td>
                                                            </tr>
                                                               <?php
