...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Add Handfeed Details</title>
    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Add Handfeed Details</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>Handfeeding/handfeeding">View Handfeed Details</a></li>
                                    <li class="active">Add Handfeed Details</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Add Handfeed Details</h3></div>
                                    <div class="panel-body">
									    <form id="handfeedForm" method="post" autocomplete="false" action="javascript:void(0)">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="actualFeed_vday" id="actualFeed_vday" >
                                                    </div>
                                                    <div class="form-group">
        ...
        <script src="<?php echo base_url();?>assets/pro_js/add_handfeed.js"></script>
        <!--script src="<?php //echo asset_url();?>pro_js/add_incubation.js"></script-->
        <script>
			var BASE_URL = "<?php echo base_url();?>index.php/";

            $(document).ready(function () {
				var  page="handfeed_details";

				if(page=="handfeed_details"){
                    $('.handfeeding_m').click();
