...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | View Handfeeding History</title>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">View Handfeeding History</h3>
                                        
                                    </div>
                                    <div class="panel-body">
                                    <form id="sales_update_form" method="post" autocomplete="false" action="<?php echo base_url()."index.php/Handfeeding/handfeeding_history"; ?>" nctype="multipart/form-data">
                                       ...
                                       <div class="col-md-2">
                                            ...
                                            <div class="form-group">
												...
												<a href="<?php echo base_url()."index.php/Handfeeding/handfeeding_history"; ?>" class="btn btn-warning">Clear</a>
                                                    ...
                                                    // print_r($handfeed_history); 
                                                     //print_r ($incub_history[0]['total_eggs']);
                                                         foreach($handfeed_history as $key=>$value) 
                                                         {
                                                              //  print_r($value);
                                                               ...
                                                               $total_chicks_percent = ($total_chicks/$total_chicks)*100;
                                                                ...
                                                                $total_preweaning_percent = round(($total_preweaning/$total_chicks)*100,2);
                                                        ...
                                                        ?>
                                                          <tr>
                                                           ...
                                                           if(isset($from_date)){
                                                            ...
                                                            ?>
                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Handfeeding/handfeeding_history_view"; ?>" method="post">
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td style="font-weight:bold;"><?php echo $total_preweaning_percent.'%'; ?></td>
                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Handfeeding/handfeeding_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                                    <input type="hidden" name="type" value="prewean">
                                                                    <input type="submit" value="View">
                                                           </form></td>                                                        </tr>
                                                        <tr>
                                                           <td>3</td>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
  ...
  <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/jquery.dataTables.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/buttons.colVis.min.js"></script>
        ...
        <script type="text/javascript">
        $(document).ready(function () {
            var  page="handfeeding_history";
				
				if(page=="handfeeding_history"){
                    $('.handfeeding_m').click();
					$(".handfeeding_history").addClass("active");
				}
