...
<html>
    <head>
	  ...
	  if($datawhere == "prewean"){
	  	$page_name = " Chicks moved to Preweaning";
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <li><a href="<?php echo base_url(); ?>index.php/Handfeeding/handfeeding_history">Handfeeding history</a></li>
                                <li class="active">View Handfeeding History</li>
                            </ol>
