...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Add Handfeeding Details</title>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Add handfeeding Temperature Details</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="view_incubationTemp">View handfeeding Details</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Add handfeeding Temperature Details</h3></div>
                                    <div class="panel-body">
									    <form id="handfeedTemp" method="post" autocomplete="false" action="javascript:void(0)">
                                           ...
                                           <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="incubation_no">BROODER*</label>
                                                        <select name="brooder_name" id="brooder_name" class="select2" required>
                                      ...
                                      <thead>
                                            ...
                                            <tr>
                                               ...
                                               <td><input type="text" class="SmallInput"  name="temp6" id="temp6" ></td>
                                                 ...
                                                 <td><input type="text" class="SmallInput"  name="hum6" id="hum6" ></td>
                                                ...
                                                <tr>
                                                 ...
                                                 <td><input type="text" class="SmallInput"  name="rotate6" id="rotate6" ></td>
                                                ...
                                                <tr>
                                                 <th scope="row">Total No of chicks</th>
                                                 <td><input type="text" class="SmallInput"  name="eggno6" id="eggno6" ></td>
                                                ...
                                                <tr>
                                                 ...
                                                 <td><select name="user6" id="user6" class="select2">
...
<script src="<?php echo asset_url();?>pro_js/add_handfeedtemp.js"></script>
<script>
			var BASE_URL = "<?php echo base_url();?>index.php/";

            $(document).ready(function () {
				var  page="handfeeding_temperature";

				if(page=="handfeeding_temperature"){
                    $('.handfeeding_m').click();
