...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> | Handfeeding Temperature Details</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">Handfeeding Temperature Details</h4>
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Handfeeding/add_handfeedtemperature">Add Handfeedding temperature
                                        Details</a></li>
                                <li class="active"> Handfeeding Temperature Details</li>
                            </ol>
                        </div>
                    </div>
...
<div id="temp-modal"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog modal-full"> 
                                        <div class="modal-content"> 
                                            ...
                                            <table id="temp_tb" class="table table-bordered table-responsive">
                                                   <thead>
                                                   <tr>
                                                            <!--th>#</th-->
                                                            <th>Sno</th>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Handfeeding Temperature & Humidity Details</h3>
                                </div>
                                <div class="panel-body">
                                    <a href="<?php echo base_url(); ?>index.php/Handfeeding/add_handfeedtemperature"><button
                                            class="btn btn-primary waves-effect waves-light">Add Temperature & Humidity</button></a>
                                            <a href="<?php echo base_url(); ?>index.php/Handfeeding/datalog"><button
                                            class="btn btn-primary waves-effect waves-light">Datalog</button></a>
                                  ...
                                  <br><br>
                                       ...
                                       <div class="form-group">
                                               ...
                                               <div class="col-md-2">
                                               <div class="form-group">
                                                        <label for="brooder_name">BROODER*</label>
                                                        <select name="brooder_name'" id="brooder_name" class="select2 form-control" required>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" id="handfeedtemp_tb">
                                                    <thead>
                                                        <tr>
                                                            <!--th>#</th-->
                                                            <th>Sno</th>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/list_handfeed.js"></script>
    ...
    $(document).ready(function() {
        ...
        if (page == "incubtemperature") {
            $('.temhum_incubation_m').click();
            // $('.incubation_li a').addClass('subdrop');
            $('.handfeeding_m').click();

            $(".temhum_handfeeding_m").addClass("active");
        }
