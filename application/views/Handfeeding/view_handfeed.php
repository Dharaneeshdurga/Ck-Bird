...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> View Handfeed Details</title>
...
<body class="fixed-left">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">
                                View handfeed details
                            </h4>
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Handfeeding/handfeeding"></a>Handfeeding details</li>
                                <li><a href="<?php echo base_url(); ?>index.php/Handfeeding/handfeeding">View Handfeed Details</a></li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">View Handfeed</h3>
                                </div>
   ...
   <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/jquery.dataTables.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/view_handfeed.js"></script>
