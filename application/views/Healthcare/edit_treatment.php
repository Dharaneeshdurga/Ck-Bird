    ...
    <body class="fixed-left">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb pull-right">
                                    <li><a href="view_treatment">View Add Treatment Register Details</a></li>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
									    <form id="edit_treat_form" method="post" autocomplete="false" action="javascript:void(0)">
                                        <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" id="aviary_id"
                                                    ...
                                                    <input type="hidden" class="form-control" id="bird_count"
        ...
        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="eegring_no"
                                                    name="eegring_no"  placeholder="" readonly>
                                            </div>
        </div>
        </div><br>
        <div class="row">
        ...
        <script src="<?php echo asset_url();?>pro_js/healthcare/edit_treatment.js"></script>
        <script>
