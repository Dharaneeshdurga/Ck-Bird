...
<html>
    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title"> Add Mortality </h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="view_mort"> View Mortality & Postmortem Register</a></li>
                                    <li class="active"> Add Mortality </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title"> Add Mortality </h3></div>
                                    <div class="panel-body">
									    <form id="mort_form" method="post" autocomplete="false" action="javascript:void(0)">
                                        <div class="row">
		...
		<div class="col-md-2">
        <div class="form-group">
                                                <label for="cage">Date of mortality*</label>
                                                <input type="date" class="form-control" id="mort_date"
                                                    name="mort_date" placeholder="" readonly>
...
<span style="color:green"> Formats allowed:wmv|mp4|avi|mov</span>
        ...
        <script src="<?php echo asset_url();?>pro_js/healthcare/mort.js"></script>
        <script>
