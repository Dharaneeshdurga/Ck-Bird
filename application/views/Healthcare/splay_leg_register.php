...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Add Splay Leg Chick Register</title>
    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Add Splay Leg Chick Register </h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="view_splay">View Splay Leg Chick Register</a></li>
                                    <li class="active">Add Splay Leg  Chick Register</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Add Splay Leg Chick Register</h3></div>
                                    <div class="panel-body">
									    <form id="splay_chick_form" method="post" autocomplete="false" action="javascript:void(0)">
                                        <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="cage">Date*</label>
                                                <input type="date" class="form-control" id="splay_date"
                                                    name="splay_date" placeholder="" required>
                                    ...
                                    <div class="col-md-3">
                                       ...
                                       <div class="col-md-3">
                                         <div class="form-group">
                                                        <label for="clutch_no">No of splay legged Chick(MP) </label>
                                 ...
                                 <div class="col-md-3">
                                         <div class="form-group">
                                                        <label for="clutch_no">No of splay legged chick(FP) </label>
                              ...
                              <input type="text" class="select2 form-control" id="egg_weight" name="egg_weight" required>
                                     ...
                                     <div class="col-md-3">
                                         <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                         <div class="form-group">
                                                        <label for="clutch_no">Date of Detection of Splay leg</label>
                                                        <input type="date" class="select2 form-control" id="detect_date" name="detect_date" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                               <div class="form-group">
        ...
        <script>
            ...
            $(document).ready(function () {
                var page = "splay_register";

if (page == "splay_register") {
    $('.healthcare_m').click();
