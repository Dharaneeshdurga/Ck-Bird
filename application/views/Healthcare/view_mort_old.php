...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> |Postmoderm Register</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <!-- <h4 class="pull-left page-title">Postmortem Register</h4>
...
<!-- move to handfeeding modal -->  
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Postmortem Register</h3>
                                </div>
                                                ...
                                                <table class="table table-striped table-bordered" id="mort_tb">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Division</th>
                                                            <th>History</th>
                                                            <th>Carcass  Weight (gm)</th>
                                                            <th>BCS</th>
                                                            <th>PM Lesions</th>
                                                            <th>Tentative Diagnosis</th>
                                                            <th>Confirmative Diagnosis</th>
                                                            <th>Cause categorization</th>
                                                            <th>Action</th>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/healthcare/view_pm.js"></script>
