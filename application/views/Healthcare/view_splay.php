...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> | Splay Leg Chick Register Details</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">Splay Leg Chick Register Details</h4>
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Healthcare/splay_leg_register">Add Splay Leg Chick Register</a></li>
                                <li class="active">Splay Leg Chick Register Details</li>
                            </ol>
                        </div>
                    </div>
<!-- move to handfeeding modal -->  
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Splay Leg Chick Register Details</h3>
                                </div>
                                <div class="panel-body">
                                    <a href="<?php echo base_url(); ?>index.php/Healthcare/splay_leg_register"><button
                                            class="btn btn-primary waves-effect waves-light">Add Splay Leg Chick Register</button></a>
                                           <br><br>
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="Ring_no">BIRD RING NO/EGG NO*</label>
                                                        <select name="ring_no" id="egg_no" name="egg_no" class=" form-control" required>
                                                            <option value="">Select Ring/Egg no</option>
                                                        </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" id="splay_tb">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>No of splay legged chicks(MP)</th>
                                                            <th>Female parent ring no</th>
                                                            <th>No of splay legged chicks(FP)</th>
                                                            <th>Egg Weight</th>
                                                            <th>Standard Egg Weight</th>
                                                            <th>Hatch Weight</th>
                                                            <th>Standard hatch weight</th>
                                                            <th>Detect date</th>
                                                            <th>Corrective measures Adaptive</th>
                                                            <th>Status</th>
                                                            <th>Action</th>
                                                            <!--th>Stunded From Day</th>
                                                            <th>Standard weaning Days</th>
                                                            <th>Handfeeding chick issue</th>
                                                            <th>Corrective measures Adaptive</th-->
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/healthcare/view_splay.js"></script>
    <script src="<?php echo base_url();?>assets/pro_js/healthcare/stund.js"></script>
