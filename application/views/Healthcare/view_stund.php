...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> | Stunted Chick Register Details</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">Stunted Chick Register Details</h4>
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Healthcare/stund_register">Add Stunted Chick Register</a></li>
                                <li class="active">Stunted Chick Register Details</li>
                            </ol>
                        </div>
                    </div>
...
<div id="eggd-modal"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Stunted Chick Register Details</h3>
                                </div>
                                <div class="panel-body">
                                    <a href="<?php echo base_url(); ?>index.php/Healthcare/stund_register"><button
                                            class="btn btn-primary waves-effect waves-light">Add Stunted Chick Register</button></a>
                                           <br><br>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" id="stunt_tb">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Sno</th>
                                                            ...
                                                            <th>No of Stunted chicks(MP)</th>
                                                            <th>Female parent ring no</th>
                                                            <th>No of Stunted chicks(FP)</th>
                                                            <th>Egg Weight</th>
                                                            <th>Standard Egg Weight</th>
                                                            <th>Hatch Weight</th>
                                                            <th>Standard hatch weight</th>
                                                            <!--th>Clutch no</th>
                                                            <th>Egg no in current clutch</th-->
                                                            <th>Status</th>
                                                            <th>Action</th>
                                                            <!--th>Stunted From Day</th>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/healthcare/view_stund.js"></script>
