...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> | Treatment Register Details</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Healthcare/add_treatment">Add Treatment Register Details</a></li>
...
<div id="eggd-modal"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Treatment Register Details</h3>
                                </div>
                                <div class="panel-body">
                                    <a href="<?php echo base_url(); ?>index.php/Healthcare/add_treatment"><button
                                            class="btn btn-primary waves-effect waves-light">Add Treatment Register Details</button></a>
                                           <br><br>
                                            <div class="row">
                                            <div class="col-md-2">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" id="treatment_tb">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>sno</th>
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/healthcare/view_treatment.js"></script>
    ...
    $(document).ready(function() {
     ...
     /*   $('#proven_tb').DataTable( {
        ...
        var page = "view_treatment";

if (page == "view_treatment") {
    $('.healthcare_m').click();
