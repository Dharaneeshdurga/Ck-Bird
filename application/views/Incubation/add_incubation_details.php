            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Add Incubation Details</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="incubation">View Incubation Details</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Add Incubation Details</h3></div>
                                    <div class="panel-body">
									    <form id="incubationForm" method="post" autocomplete="false" action="javascript:void(0)">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="bird_group" id="bird_group" class="select2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="bird_species" id="bird_species" class="select2" required>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="select2" name="male_parent_rno" id="male_parent_rno">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="select2" name="female_parent_rno" id="female_parent_rno">
                                                            <option value="">Select</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span id="egg_no-error" class="error" for="egg_no" style="display:none;">Egg No: Already Exists..!</span>
                                                        <span id="egg_no-success" class="text-success" for="egg_no" style="display:none;">Egg No: Free to Use..! Please avoid space</span>
                                                    </div>
                                                    <!--div class="form-group">
                                                    ...
                                                    <div class="form-group"  id="fertile_show">
                                                        ...
                                                        <select class="select2" id="fertile_type" name="fertile_type">
											...
											<div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="dis_date">Dis Weight</label>
                                            ...
                                            <div class="row" id="fertile_div" style="display:none">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="hatch_type" id="hatch_type" class="select2">
												...
												<div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="dis_date">Egg length</label>
                                            ...
                                            <!--div class="row" id="infertile_div" style="display:none">
                                                <h4>In Fertile Details</h4>
