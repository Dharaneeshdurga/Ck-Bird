...
<head>
    ...
    <title><?php echo $this->session->userdata('client_name'); ?> View Weight loss Details</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">
                                View Weight Loss history details
                            </h4>
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Incubation/incubation"></a>Update weight loss</li>
                                <li class="active"></li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">View Weight loss History</h3>
                                </div>
                                <div class="panel-body">
                                <table id="view_weightloss_tb" class="table table-bordered">
                                                   <thead>
...
<tbody>
    ...
    <tr>
        ...
        <td><input type="text" name="elaid_date" id="elaid_date"
                class="form-control"></td>
    </tr>
    <tr>
        <th>Pip Date</th>
        <td><input type="text" name="pip_date" id="pip_date"
                class="form-control"></td>
    </tr>
    <tr>
        <th>Hatch Date</th>
        <td><input type="text" name="hatch_date" id="hatch_date"
                class="form-control"></td>
    </tr>
    <tr>
   ...
   <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/jquery.dataTables.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/view_weightloss.js"></script>
    ...
    <script type="text/javascript">
    $(document).ready(function() {
        var page = "view_handfeed";

        if (page == "view_handfeed") {
            $('.incubation_m').click();
