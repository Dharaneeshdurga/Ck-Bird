...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Add Aviary Details</title>
                                    ...
                                    <div class="modal-dialog"> 
                                        <div class="modal-content"> 
                                            <div class="modal-header"> 
                                                ...
                                                <h4 class="modal-title">ADD AVIARY</h4> 
                                            </div> 
                                            <form name="aviary_form" id="aviary_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/add_aviary'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                            <div class="modal-body"> 
                                                <div class="row"> 
                                                    <div class="col-md-6"> 
                                                        <div class="form-group"> 
                                                            <label for="Aviary Name" class="control-label">Aviary Name</label>
                                                            ...
                                                            <input type="text" name="aviary_name" id="aviary_name" class="form-control" required>
                                                        </div> 
                                                    </div> 
                                            ...
                                            <div class="modal-footer"> 
                                                ...
                                                <button type="submit" class="btn btn-info waves-effect waves-light">Add Aviary</button> 
                                            </div> 
                                            </form>
                                        </div> 
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Aviary List</h3>
                                    ...
                                    <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">
                                     ...
                                     <div class="col-md-2">
                                         <a href="<?php echo base_url('index.php/Download/export_aviary_csv'); ?>" class="btn btn-info waves-effect waves-light" ><i class="fa fa-pencil-square-o"></i>Download Sample</a>
                                    </div>
                                    <div class="col-md-8">
                                        <form id="raw_material"   action="<?php echo base_url("index.php/Download/aviary_upload") ?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                              <div class="col-md-3">  
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $count = 0;
                                                        foreach($aviary as $k => $val ){
                                                         	$branch_id = $this->session->userdata('branch_id');
                                                         if($branch_id == $val['branch_id']){
                                                             $count ++;?>
                                                            <tr>
                                                                <td class="<?php if($val['status']==0) { echo "danger"; } ?>"><?php echo $count; ?></td>
                                                                <td class="<?php if($val['status']==0) { echo "danger"; } ?>"><?php echo $val['aviary_name']; ?></td>
                                                                <td class="<?php if($val['status']==0) { echo "danger"; } ?> text-center"> 
                                                                                             
                                                                <a href="<?php echo base_url('index.php/Masters/edit_aviary/'.$val['id']); ?>" class="btn btn-primary btn-xs" ><i class="fa fa-pencil-square-o"></i></a> &nbsp;&nbsp;
                                                    ...
                                                    <a  onclick="get_delete_pop('<?php echo $val['id'];?>','ckb_aviary');" href="#" class="btn btn-danger btn-xs "><i class="fa fa-close"></i> </a>
  ...
  swal({   
      ...
      text: "You will not be able to recover this AVIARY and all the data related this aviary also affected!!!",   
      type: "warning",   
