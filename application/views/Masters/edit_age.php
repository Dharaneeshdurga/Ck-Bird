                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                	Edit Species Age and Weight
                                 </h4>
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/aviary"> List</a></li>
                                    <li class="active">Edit Species Age and Weight
                            </div></li>
                                </ol>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Species Age and Weight</h3></div>
                                    <div class="panel-body">
                                       <form name="brooder_form" id="brooder_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_brooder/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	<input type="hidden" name="a_id" value="<?php //echo $_GET['val']; ?>"  >
                                            
                                                <div class="form-group"> 
                                                    <label for="Brooder Name" class="control-label">Brooder Name</label>
                                                    <input type="text" name="brooder_name" id="brooder_name" class="form-control" value="<?php echo $spc_info['species_id']; ?>">
                                                </div>
