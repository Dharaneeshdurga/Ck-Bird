...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Branch Details</title>
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/branch">Branch List</a></li>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                       <form name="aviary_form" id="aviary_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_branch/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	<input type="hidden" name="br_id" value="<?php echo $br_info['id']; ?>"  >
                                        
                                                <div class="form-group"> 
                                                    <label for="Branch Name" class="control-label">Branch Name</label>
                                                    <input type="text" name="branch_name" id="branch_name" class="form-control" value="<?php echo $br_info['branch_name']; ?>">
                                                </div>
