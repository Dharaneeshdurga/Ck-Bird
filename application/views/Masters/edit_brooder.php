...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Brooder Details</title>
    ...
    <body class="fixed-left">
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/aviary">Brooder List</a></li>
                                    <li class="active">Edit Brooder
                            </div></li>
                                </ol>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Brooder</h3></div>
                                    <div class="panel-body">
                                       <form name="brooder_form" id="brooder_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_brooder/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	<input type="hidden" name="a_id" value="<?php echo $broo_info['id']; ?>"  >
                                            
                                                <div class="form-group"> 
                                                    <label for="Brooder Name" class="control-label">Brooder Name</label>
                                                    <input type="text" name="brooder_name" id="brooder_name" class="form-control" value="<?php echo $broo_info['brooder_name']; ?>">
                                                </div>
                                                <div class="form-group"> 
                                                <label for="Species Name" class="control-label">Target No of Feeds</label>
                                                 
                                                <input type="text" name="target_feed" id="target_feed" class="form-control" value="<?php echo $broo_info['target_feed']; ?>">
                                            </div>
        ...
        <script type="text/javascript">
        $(document).ready(function () {
            var  page="edit_brooder";
				
				if(page=="edit_brooder"){
                    $(".settings_m").click();
