...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Cage Details</title>
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/cage">Cage List</a></li>
                                    <li class="active">Edit Cage</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Cage</h3></div>
                                    <div class="panel-body">
                                       <form name="cage_form" id="cage_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_cage/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	 <input type="hidden" name="c_id" value="<?php echo $cag_info['id']; ?>"  >
                                             ...
                                             <div class="form-group">
                                                <label for="Aviary">Select Aviary Name</label>
                                                     <select name="aviary_id" class="form-control" required>
                                                            ...
                                                            <option value="<?php echo $aviary['auto_id'] ?>" <?php echo ($cag_info['aviary_id'] ==$aviary['auto_id']?'selected':'');  ?>><?php echo $aviary['aviary_name']; ?></option>
                                                            <?php } ?>
                                                    </select>
                                            </div>
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <input type="text" name="cage" id="cage" class="form-control" value="<?php echo $cag_info['cage']; ?>">
                                            </div>
                                            
                                             <!--<div class="form-group"> 
                                                <label for="Cage Name" class="control-label">No of Birds</label>
                                                 
                                                <input type="text" name="no_of_birds" id="no_of_birds" class="form-control" value="<?php //echo $cag_info['no_of_birds']; ?>">
                                            </div>-->
											<div class="form-group"> 
														<label for="diet" class="control-label">Diet pattern</label>
														<select name="diet" class="form-control" required>
														<option value="">select</option>
														<option selected><?php echo $cag_info['diet_pattern']; ?></option>
                                                        ...
                                                        <input type="text" name="mrng_feed" id="mrng_feed" class="form-control" value="<?php echo $cag_info['target_mrg_feed']; ?>">
                                                        </div>

														<div class="form-group"> 
														<label for="aft_feed" class="control-label">Target Afternoon Feed</label>
                                                        <input type="text" name="aft_feed" id="aft_feed" value="<?php echo $cag_info['target_aft_feed']; ?>" class="form-control" required>
                                                        </div>
