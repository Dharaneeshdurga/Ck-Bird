...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Employee Details</title>
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/employe">Employees List</a></li>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                       <form name="proven_form" id="proven_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_employe/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	 <input type="hidden" name="r_id" value="<?php echo $r_id['id']; ?>"  >
                                            <div class="form-group"> 
                                                            <label for="Employee Name" class="control-label">Employee Name</label>
                                                            <input type="text" name="employe_name" id="employe_name" class="form-control" value="<?php echo $r_id['user_name']; ?>">
                                                        </div>
                                                        <div class="form-group"> 
                                                            <label for="Employee Id" class="control-label">Employee Id</label>
                                                            <input type="text" name="employe_id" id="employe_id" class="form-control" value="<?php echo $r_id['user_id']; ?>">
                                                            <input type="hidden" name="emp_roles1" id="emp_roles1" class="form-control" value="<?php echo $r_id['role_type']; ?>">
                                                            <input type="hidden" name="branch_id1" id="branch_id1" class="form-control" value="<?php echo $r_id['branch_id']; ?>">

                                                        </div>
                                                        <div class="form-group"> 
                                                            <label for="Select Roles" class="control-label">Select Roles</label>
                                                           
                                                                <select name="emp_roles" id="emp_roles_edit" class="form-control">
                                                                <!-- <option value="<?php// echo $r_id['role_type']; ?>"><?php //echo $r_id['role_type']; ?></option> -->
                                                                </select>
                                                        </div>
                                                        <div class="form-group"> 
                                                            <label for="Branch Id" class="control-label">Branch Name</label>
                                                            <select name="branch_id" id="branch_edit" class="form-control">
                                                                <!-- <option value="<?php echo $r_id['branch_id']; ?>"><?php echo $r_id['branch_name']; ?></option> -->
                                                                </select>
                                                        </div>
