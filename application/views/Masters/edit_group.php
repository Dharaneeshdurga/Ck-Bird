...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Group Details</title>
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/group">Group List</a></li>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                       <form name="group_form" id="group_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_group/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	 <input type="hidden" name="g_id" value="<?php echo $gro_info['id']; ?>"  >
                                            <div class="form-group"> 
                                                            <label for="Group Name" class="control-label">Group Name</label>
                                                             
                                                            <input type="text" name="group_name" id="group_name" class="form-control" value="<?php echo $gro_info['group_name']; ?>">
                                                        </div>
