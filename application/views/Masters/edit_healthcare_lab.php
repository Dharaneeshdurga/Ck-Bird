...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Lab Diagnostics list</title>
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/lab_diag">Lab Diagnostics list</a></li>
                                    <li class="active">Edit Lab Diagnostics list</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Lab Diagnostics list</h3></div>
                                    <div class="panel-body">
                                       <form name="aviary_form" id="aviary_form" class="form-horizontal form-bordered" action="<?php echo base_url('Healthcare/edit_healthcare_lab/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	<input type="hidden" name="a_id" value="<?php echo $avi_info['id']; ?>"  >
                                            
                                                <div class="form-group"> 
                                                    <label for="Diag name" class="control-label">lab Diagnostics Name</label>
                                                    <input type="text" name="diag_name" id="diag_name" class="form-control" value="<?php echo $avi_info['diag_name']; ?>">
                                                </div>
