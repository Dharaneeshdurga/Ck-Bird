...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Samples Collected list</title>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                	Edit Samples Collected list
                                 </h4>
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/samples_collected">Samples Collected list</a></li>
                                    <li class="active">Edit Samples Collected list</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Samples Collected list</h3></div>
                                    <div class="panel-body">
                                       <form name="aviary_form" id="aviary_form" class="form-horizontal form-bordered" action="<?php echo base_url('Healthcare/edit_healthcare_samples/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	<input type="hidden" name="a_id" value="<?php echo $avi_info['id']; ?>"  >
                                            
                                                <div class="form-group"> 
                                                    <label for="Samples name" class="control-label">Samples Name</label>
                                                    <input type="text" name="samples_name" id="samples_name" class="form-control" value="<?php echo $avi_info['samples_name']; ?>">
                                                </div>
                                            	<div class="form-group"> 
                                                            <label for="test" class="control-label" >Test for</label>
                                                         
                                                            <input type="text" name="test_for" id="test_for"  class="form-control" value="<?php echo $avi_info['test_for']; ?>">
                                                        </div> 
														<div class="form-group"> 
                                                            <label for="Inference" class="control-label" >Inference</label>
                                                         
                                                            <input type="text" name="inference" id="inference"  class="form-control" value="<?php echo $avi_info['inference']; ?>">
                                                        </div>
														<div class="form-group"> 
                                                            <label for="Result" class="control-label" >Result</label>
                                                         
                                                            <input type="text" name="result" id="result"  class="form-control" value="<?php echo $avi_info['result']; ?>">
                                                        </div>
