...
<html>
    ...
    <body class="fixed-left">
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/aviary">Incubation List</a></li>
                                    <li class="active">Edit Incubation
                            </div></li>
                                </ol>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Incubation</h3></div>
                                    <div class="panel-body">
                                       <form name="incubation_form" id="incubation_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_incubation/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	<input type="hidden" name="a_id" value="<?php echo $incu_info['id']; ?>"  >
                                            
                                                <div class="form-group"> 
                                                    <label for="incubation Name" class="control-label">Incubation Name</label>
                                                    <input type="text" name="incubation_name" id="incubation_name" class="form-control" value="<?php echo $incu_info['incubation_name']; ?>">
                                                </div>
        ...
        <script type="text/javascript">
        $(document).ready(function () {
            var  page="edit_incubation";
				
				if(page=="edit_incubation"){
                    $(".settings_m").click();
