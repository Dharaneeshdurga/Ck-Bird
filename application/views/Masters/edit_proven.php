...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Proven Details</title>
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/proven">Proven List</a></li>
                                    <li class="active">Edit Proven</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Proven</h3></div>
                                    <div class="panel-body">
                                       <form name="proven_form" id="proven_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_proven/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	 <input type="hidden" name="p_id" value="<?php echo $pro_info['id']; ?>"  >
                                            <div class="form-group"> 
                                                            <label for="Proven Name" class="control-label">Proven Name</label>
                                                             
                                                            <input type="text" name="title" id="title" class="form-control" value="<?php echo $pro_info['title']; ?>">
                                                        </div>
