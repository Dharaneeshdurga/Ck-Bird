...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Edit Roles Details</title>
                            ...
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">
                                 ...
                                 <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo base_url(); ?>index.php/Masters/view_roles">Roles List</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Roles</h3></div>
                                    <div class="panel-body">
                                       <form name="proven_form" id="proven_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/edit_roles/update'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                        	 <input type="hidden" name="r_id" value="<?php echo $r_id['id']; ?>"  >
                                            <div class="form-group"> 
                                                            <label for="Roles Name" class="control-label">Roles Name</label>
                                                             
                                                            <input type="text" name="role_name" id="role_name" class="form-control" value="<?php echo $r_id['roles_name']; ?>">
                                                        </div>
                                                        <div class="form-group"> 
                                                            <label for="Proven Name" class="control-label">Roles Description</label>
                                                             
                                                            <input type="text" name="roles_desc" id="roles_desc" class="form-control" value="<?php echo $r_id['roles_desc']; ?>">
                                                        </div>
