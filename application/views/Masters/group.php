...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Group Details</title>
                                 ...
                                 <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog"> 
                                        <div class="modal-content"> 
                                            ...
                                            <form name="group_form" id="group_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/add_group'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                            <div class="modal-body"> 
                                                <div class="row"> 
                                                    <div class="col-md-6"> 
                                                        <div class="form-group"> 
                                                            <label for="Group Name" class="control-label">Group Name</label>
                                                             <!-- <input type="hidden" name="auto_id" id="auto_id" class="form-control" value="<?php// $last_id=$last_id['id']+1; echo "G00".$last_id; ?>">  -->
                                            ...
                                            <div class="modal-footer"> 
                                                ...
                                                <button type="submit" class="btn btn-info waves-effect waves-light">Add Group</button> 
                                            </div> 
                                            </form>
                                        </div> 
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="col-md-2">
                                         <a href="<?php echo base_url('index.php/Download/group_Download'); ?>" class="btn btn-info waves-effect waves-light" ><i class="fa fa-pencil-square-o"></i>Download Sample</a>
                                    </div>
                                    <div class="col-md-8">
                                        <form id="raw_material"   action="<?php echo base_url("index.php/Download/group_upload") ?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                              <div class="col-md-3">  
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                         $count =0;
                                                        foreach($group as $k => $val ){ $branch_id = $this->session->userdata('branch_id');
                                                         if($branch_id == $val['branch_id']){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <a href="<?php echo base_url('index.php/Masters/edit_group/'.$val['id']); ?>" class="btn btn-primary btn-xs" ><i class="fa fa-pencil-square-o"></i></a> &nbsp;&nbsp;
                                                    ...
                                                    <a  onclick="get_delete_pop('<?php echo $val['id'];?>','ckb_group');" href="#" class="btn btn-danger btn-xs "><i class="fa fa-close"></i> </a>
        ...
        $(document).ready(function () {
			...
			$(document).ready(function() {
			    $(document).on('click','.inactive_doc',function(){
					var resp = confirm("Do you want to Inactive this Group?");
					if (resp == true) {
						var inactive_id = $(this).attr('inactive_id');
						//alert(inactive_id);
						$.ajax({
							type : "POST", 
							url : "<?php echo base_url(); ?>index.php/Masters/inactive_group",
			...
			$(document).ready(function() {
			    $(document).on('click','.active_doc',function(){
					var resp = confirm("Do you want to active this Group?");
					if (resp == true) {
						var active_id = $(this).attr('active_id');
						//alert(active_id);
						$.ajax({
							type : "POST", 
							url : "<?php echo base_url(); ?>index.php/Masters/active_group",
  ...
  swal({   
      ...
      text: "You will not be able to recover this GROUP and all the data related this group also affected!!!",   
      type: "warning",   
