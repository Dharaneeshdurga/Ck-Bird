...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Add Incubation Details</title>
                                    ...
                                    <div class="modal-dialog"> 
                                        <div class="modal-content"> 
                                            <div class="modal-header"> 
                                                ...
                                                <h4 class="modal-title">ADD INCUBATION</h4> 
                                            </div> 
                                            <form name="incubation_form" id="incubation_form" class="form-horizontal form-bordered" action="<?php echo base_url('index.php/Masters/add_incubation'); ?>" enctype="multipart/form-data"  data-parsley-validate method="post" autocomplete="off">
                                            <div class="modal-body"> 
                                                <div class="row"> 
                                                    <div class="col-md-6"> 
                                                        <div class="form-group"> 
                                                            <label for="Incubation Name" class="control-label">Incubation Name</label>
                                                            ...
                                                            <input type="text" name="incubation_name" id="incubation_name" class="form-control" required>
                                                        </div> 
                                                    </div> 
                                            ...
                                            <div class="modal-footer"> 
                                                ...
                                                <button type="submit" class="btn btn-info waves-effect waves-light">Add Incubation</button> 
                                            </div> 
                                            </form>
                                        </div> 
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Incubation List</h3>
                                    ...
                                    <div class="col-md-2">
                                         <a href="<?php echo base_url('index.php/Download/incub_Download'); ?>" class="btn btn-info waves-effect waves-light" ><i class="fa fa-pencil-square-o"></i>Download Sample</a>
                                    </div>
                                    <div class="col-md-8">
                                        <form id="raw_material" action="<?php echo base_url("index.php/Download/incub_upload") ?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                              <div class="col-md-3">  
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php $count=0; foreach($incubation as $k => $val ){ $branch_id = $this->session->userdata('branch_id');
                                                         if($branch_id == $val['branch_id']){
                                                             $count++;?>
                                                            <tr>
                                                                <td class="<?php if($val['status']==0) { echo "danger"; } ?>"><?php echo $count; ?></td>
                                                                <td class="<?php if($val['status']==0) { echo "danger"; } ?>"><?php echo $val['incubation_name']; ?></td>
                                                                <td class="<?php if($val['status']==0) { echo "danger"; } ?> text-center"> 
                                                                                             
                                                                <a href="<?php echo base_url('index.php/Masters/edit_incubation/'.$val['id']); ?>" class="btn btn-primary btn-xs" ><i class="fa fa-pencil-square-o"></i></a> &nbsp;&nbsp;
                                                    ...
                                                    <?php } ?>
                                                    <a  onclick="get_delete_pop('<?php echo $val['id'];?>','ckb_addincubation');" href="#" class="btn btn-danger btn-xs "><i class="fa fa-close"></i> </a>
        ...
        $(document).ready(function () {
			...
			$(document).ready(function() {
			    $(document).on('click','.inactive_doc',function(){
					var resp = confirm("Do you want to Inactive this Incubation?");
					if (resp == true) {
						var inactive_id = $(this).attr('inactive_id');
						//alert(inactive_id);
						$.ajax({
							type : "POST", 
							url : "<?php echo base_url(); ?>index.php/Masters/inactive_incubation",
			...
			$(document).ready(function() {
			    $(document).on('click','.active_doc',function(){
					var resp = confirm("Do you want to active this Incubator?");
					if (resp == true) {
						var active_id = $(this).attr('active_id');
						//alert(active_id);
						$.ajax({
							type : "POST", 
							url : "<?php echo base_url(); ?>index.php/Masters/active_incubation",
  ...
  swal({   
      ...
      text: "You will not be able to recover this INCUBATION and all the data related this incubation also affected!!!",   
      type: "warning",   
