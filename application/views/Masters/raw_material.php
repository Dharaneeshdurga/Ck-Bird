...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Raw Material</title>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Import Raw material details</h3>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class ="row">
                                        <div class="col-md-9">
                                        <a href="<?php echo base_url('index.php/Import/material_Download'); ?>" class="btn btn-primary waves-effect waves-light" ><i class="fa fa-pencil-square-o"></i>Download Sample</a>
                                    <!--button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">
                                     Add Species
                                     </button-->
                                    </div>
                                     <div class="col-md-3">
                                        <form id="raw_material" style="margin-top: -55px;" action="<?php echo base_url("index.php/Import/uploadMat") ?>" method="post" enctype="multipart/form-data">
                                                                <!--form id="species_list" action="javascript:void(0)" method="post" enctype="multipart/form-data"-->
                                                       
                                                          <input type="hidden" id="gp_id" name="gp_id"/><br>
                                                          <input type="hidden" id="aviary" name="aviary"/><br>
                                        ...
                                        <!--div class="fileUpload btn btn-purple waves-effect waves-light">
                                            <span><i class="ion-upload m-r-5"></i></span>
                                            <input type="file" class="upload" onclick = "upload_materials();">
                                        </div-->
                                    </div>                             
                                    </div>
                                                <div class="">
                                                    <table class="table table-striped table-bordered" id="raw_material_tb">
                                                        <thead>
                                                            <tr>
                                                            <th>S.No</th>
                                                            <th>Aviary</th>
    ...
    <script src="<?php echo asset_url();?>notifications/notifications.js"></script>
        ...
        $(document).ready(function () {
				var  page="raw_material";
				
				if(page=="raw_material"){
                    $(".settings_m").click();

					$(".raw-material").addClass("active");
