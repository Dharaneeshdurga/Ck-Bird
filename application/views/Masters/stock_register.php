...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Stock Register</title>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Import Stock Register details</h3>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class ="row">
                                        <div class="col-md-9">
                                        <a href="<?php echo base_url('index.php/Download/stock_register_csv'); ?>" class="btn btn-primary waves-effect waves-light" ><i class="fa fa-pencil-square-o"></i>Download Sample</a>
                                    <!--button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">
                                     Add Species
                                     </button-->
                                    </div>
                                     <div class="col-md-3">
                                        <form id="stock register"  action="<?php echo base_url("index.php/Download/stock_register_upload") ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="">
                                                    <table class="table table-striped table-bordered" id="stock_upload">
                                                        <thead>
                                                            <tr>
                                                            <th>S.No</th>
                                                            <th>Particulars</th>
    ...
    <script src="<?php echo asset_url();?>notifications/notifications.js"></script>
        ...
        $(document).ready(function () {
				var  page="stock-register";
				
				if(page=="stock-register"){
                    $(".settings_m").click();

					$(".stock-register").addClass("active");
					
				}
			
                var ct = $('#stock_upload').DataTable({
