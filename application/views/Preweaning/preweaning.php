                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Pre Weaning Details</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                        <div class="col-md-2">
                                         <a href="<?php echo base_url('index.php/Download_sample/preweaning_Download'); ?>" class="btn btn-info waves-effect waves-light" ><i class="fa fa-pencil-square-o"></i>Download Sample</a>
                                    </div>
                                    <div class="col-md-8">
                                        <form id="incub_sample" action="<?php echo base_url("index.php/Download_sample/preweaning_upload") ?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                              <div class="col-md-3">  
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered" id="preweaning_tb">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>Sno</th>
 ...
 <div class="modal-dialog"> 
                               ...
                               <div class="modal-dialog"> 
                                        <div class="modal-content"> 
                                            <div class="modal-header"> 
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
                                                <h4 class="modal-title">MOVE TO WEANING</h4> 
                                            </div> 
                                            ...
                                            <div class="modal-body"> 
                                                <div class="row"> 
                                                    <div class="col-md-6"> 
                                                     ...
                                                     <div class="form-group"> 
                                                            <label for="ring_no" class="control-label">Ring No</label><br>
                                                          
                                                            <input type = "text"  name="weaning_ring_no" class="form-control" id="weaning_ring_no" required />	
                                                     </div>
                                                    </div> 
 ...
 <script src="<?php echo asset_url();?>notifications/notify.min.js"></script>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                if(page=="preweaning"){
                    $('.preweaning_m').click();
                    $(".add_preweaning_m").addClass("active");
                }
