...
<body class="fixed-left">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">
                                View weaning details
                            </h4>
                            <ol class="breadcrumb pull-right">
                                <li><a href="<?php echo base_url(); ?>index.php/Weaning/weaning"></a>Weaning Details</li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">View Weaning details</h3>
                                </div>
   ...
   <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/jquery.dataTables.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/pro_js/view_weaning.js"></script>
    ...
    <script type="text/javascript">
    $(document).ready(function() {
        var page = "view_weaning";

        if (page == "view_weaning") {
           // $('.incubation_m').click();
