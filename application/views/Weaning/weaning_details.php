...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Add Weaning Details</title>
    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title"> Weaning Details</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="incubation">View Weaning Details</a></li>
                                    <li class="active">Weaning Details</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title"> weaning Details</h3></div>
                                    <div class="panel-body">
									    <form id="weaning_form" method="post" autocomplete="false" action="javascript:void(0)">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ratio" id="ratio" required>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="feed_date" id="feed_date" class="form-control" value="04-10-2021"--> 
                                                    <!-- </div>
                                                </div>
        ...
        <script src="<?php echo base_url();?>assets/pro_js/add_weaning.js"></script>
        <!--script src="<?php //echo asset_url();?>pro_js/add_incubation.js"></script-->
        <script>
			var BASE_URL = "<?php echo base_url();?>index.php/";

            $(document).ready(function () {
				var  page="weaning_details";

				if(page=="weaning_details"){
                    $(".weaning_m a").addClass("active");
				}
