...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | View Weaning History</title>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">View Weaning History</h3>
                                        
                                    </div>
                                    <div class="panel-body">
                                    <form id="sales_update_form" method="post" autocomplete="false" action="<?php echo base_url()."index.php/Weaning/weaning_history"; ?>" nctype="multipart/form-data">
                                       ...
                                       <div class="col-md-2">
                                            ...
                                            <div class="form-group">
												...
												<a href="<?php echo base_url()."index.php/Weaning/weaning_history"; ?>" class="btn btn-warning">Clear</a>
                                                     ...
                                                     //print_r ($incub_history[0]['total_eggs']);
                                                         foreach($wean_history as $key=>$value) 
                                                         {
                                                              //  print_r($value);
															   ...
															   $parasitic_infection = $value['parasitic_infection'];
																$nervous_incoordination = $value['nervous_incoordination'];
																$bacterial_infection = $value['bacterial_infection'];
																$viral_infection = $value['viral_infection'];
																 $nervous_coccidiosis = $value['nervous_coccidiosis'];
																 $gout = $value['gout'];

                                                               if($total_chicks >0) {
                                                               $total_chicks_percent = ($total_chicks/$total_chicks)*100;
        
                                                                $total_production_percent = round(($total_production/$total_chicks)*100,2);
																...
																$parasitic_infection_percent = round(($parasitic_infection/$total_chicks)*100,2);
																$nervous_incoordination_percent = round(($nervous_incoordination/$total_chicks)*100,2);

																$bacterial_infection_percent = round(($bacterial_infection/$total_chicks)*100,2);
																$viral_infection_percent = round(($viral_infection/$total_chicks)*100,2);
																 $nervous_coccidiosis_percent = round(($nervous_coccidiosis/$total_chicks)*100,2);
																 $gout_percent = round(($gout/$total_chicks)*100,2);
															
															}
                                                               else{
                                                                $total_chicks_percent = 0;
                                                                $total_production_percent = 0;
                                                                $splay_leg_percent =0;
                                                                $airbubble_percent =0;
                                                                $mortality_percent = 0;
                                                                $stunt_percent = 0;
                                                        ...
                                                        ?>
                                                          <tr>
                                                           ...
                                                           if(isset($from_date)){
                                                            ...
                                                            ?>
                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td style="font-weight:bold;"><?php echo $total_production_percent.'%'; ?></td>
                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                        ...
                                                        <tr>
														   ...
														   <tr>
                                                           <td>28</td>
                                                           <td>Total no of Parasitic infection</td>
                                                           <td style="font-weight:bold;"><?php echo $parasitic_infection; ?></td>
                                                           <td style="font-weight:bold;"><?php echo $parasitic_infection_percent .'%'; ?></td>

                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                                    <input type="hidden" name="type" value="parasitic_infection">
                                                                    <input type="submit" value="View">
                                                           </form></td>                                                          
                                                           </tr>
														   <tr>
                                                           <td>29</td>
                                                           <td>Total no of Nervous incoordination</td>
                                                           <td style="font-weight:bold;"><?php echo $nervous_incoordination; ?></td>
                                                           <td style="font-weight:bold;"><?php echo $nervous_incoordination_percent .'%'; ?></td>

                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                                    <input type="hidden" name="type" value="nervous_incoordination">
                                                                    <input type="submit" value="View">
                                                           </form></td>                                                          
                                                           </tr>
														   <tr>
                                                           <td>30</td>
                                                           <td>Total no of Bacterial infection </td>
                                                           <td style="font-weight:bold;"><?php echo $bacterial_infection; ?></td>
                                                           <td style="font-weight:bold;"><?php echo $bacterial_infection_percent .'%'; ?></td>

                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                                    <input type="hidden" name="type" value="bacterial_infection">
                                                                    <input type="submit" value="View">
                                                           </form></td>                                                          
                                                           </tr>
														   <tr>
                                                           <td>31</td>
                                                           <td>Total no of Viral infection </td>
                                                           <td style="font-weight:bold;"><?php echo $viral_infection; ?></td>
                                                           <td style="font-weight:bold;"><?php echo $viral_infection_percent .'%'; ?></td>

                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                                    <input type="hidden" name="type" value="viral_infection">
                                                                    <input type="submit" value="View">
                                                           </form></td>                                                          
                                                           </tr>
														   <tr>
                                                           <td>32</td>
                                                           <td>Total no of Nervous Coccidiosis </td>
                                                           <td style="font-weight:bold;"><?php echo $nervous_coccidiosis; ?></td>
                                                           <td style="font-weight:bold;"><?php echo $nervous_coccidiosis_percent .'%'; ?></td>

                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                                    <input type="hidden" name="type" value="nervous_coccidiosis">
                                                                    <input type="submit" value="View">
                                                           </form></td>                                                          
                                                           </tr>
														   <tr>
                                                           <td>33</td>
                                                           <td>Total no of Gout </td>
                                                           <td style="font-weight:bold;"><?php echo $gout; ?></td>
                                                           <td style="font-weight:bold;"><?php echo $gout_percent .'%'; ?></td>

                                                           <td><form target="_blank" action="<?php echo base_url()."index.php/Weaning/weaning_history_view"; ?>" method="post">
                                                                    <input type="hidden" name="from_date" value="<?php echo $from_date;?>">
                                                                    <input type="hidden" name="to_date" value="<?php echo $to_date;?>">
                                                                    <input type="hidden" name="type" value="gout">
                                                                    <input type="submit" value="View">
                                                           </form></td>                                                          
                                                           </tr>
                                                     </tbody>
  ...
  <script src="<?php echo base_url();?>assets/plugins/bootstrap-datatable/js/jquery.dataTables.min.js"></script>
    ...
    <!-- <script src="<?php echo base_url();?>assets/pro_js/weaning.js"></script> -->
      <script type="text/javascript">
        ...
        <script type="text/javascript">
        $(document).ready(function () {
            var  page="wean_history";
				
				if(page=="wean_history"){
                    $('.weaning_m').click();
					$(".weaning_history").addClass("active");
				}
