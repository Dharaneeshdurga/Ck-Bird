...
<html>
	...
	if($datawhere == "production"){
		$page_name = " Chicks moved to Productions";
  ...
  if($datawhere == "asp_pnuem"){
	...
	if($datawhere == "resp_distress"){
		...
		if($datawhere == "parasitic_infection"){
			  ...
			  $page_name="Parasitic infection";
			 }
	
			 if($datawhere == "nervous_incoordination"){
				
				  $page_name="Nervous incoordination";
				 }
				 if($datawhere == "bacterial_infection"){
					
					  $page_name="Bacterial infection";
					 }
					 if($datawhere == "viral_infection"){
						
						  $page_name="Viral infection";
						 }
						 if($datawhere == "nervous_coccidiosis"){
							
							  $page_name="Nervous Coccidiosis";
							 }
							 if($datawhere == "gout"){
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <li><a href="<?php echo base_url(); ?>index.php/Weaning/weaning_history">Weaning history</a></li>
                                <li class="active">view weaning details</li>
                            </ol>
                                                                         ...
                                                                         <td><?php echo $value->group_name; ?></td>
                                                                           <td><?php echo $value->bird_species; ?></td>
                                                                            <td><?php echo $value->aviary_name; ?></td>
                                                                             ...
                                                                             <td><?php echo $value->weaning_ring_no; ?></td>
																			 ...
																			 <td><?php echo date("d-m-Y", strtotime($value->move_production_date)); ?></td>
