...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Add Bird</title>
    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Add Bird</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Add Bird Details</h3></div>
                                    <div class="panel-body">
                                        <form role="form" autocomplete="false" id="birdForm">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="bird_species" id="bird_species" class="select2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="proven" id="proven" class="select2">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="ring_no" name="ring_no" oninput="check_ringno();" placeholder="Ring No">
                                                        <span id="ring_no-error" class="error" for="ring_no" style="display:none;">Ring No Already Exits..!</span>
                                                        <span id="ring_no-success" class="text-success" for="ring_no" style="display:none;">Ring No Free to Use..! Please avoid space</span>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="row" style="text-align:center;">
                                                    <button type="button" class="btn btn-purple waves-effect waves-light" id="btnSave">Submit</button>
                                            </div>
                                        </form>
                                    </div><!-- panel-body -->
                                </div> <!-- panel -->
        ...
        <script src="<?php echo base_url();?>assets/pro_js/add_bird.js"></script>
        <script>
