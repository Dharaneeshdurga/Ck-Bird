...
<html>
    <head>
        ...
        <title><?php echo $this->session->userdata('client_name'); ?> | Dashboard</title>
    ...
    <body class="fixed-left">
        ...
        <script src="<?php echo base_url();?>assets/flot-chart/jquery.flot.selection.js"></script>
        <script src="<?php echo base_url();?>assets/flot-chart/jquery.flot.stack.js"></script>
