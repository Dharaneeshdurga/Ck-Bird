$(document).ready(function() {
    ...
    get_stunt_list(date,to_date,avairy,cage,ring,sp);
  //  get_brooder();
...
function format(d) {
    ...
    '</tr>' +
    '<tr>' +
    '<td class="hide_t table-info">Age</td>' +
    '<td data-label="Remark">' + d.age + '</td>' +
    '</tr>' +
    '<tr>' +
    '<td class="hide_t table-info">Body Weight</td>' +
    '<td data-label="Remark">' + d.body_weight + '</td>' +
    '</tr>' +
...
function get_stunt_list(date,to_date,avairy,cage,ring,sp){
    //$('#hide_pdate').hide();
    var ct = $('#stunt_tb').DataTable({
        ...
        'ajax': {
            'url': BASE_URL + 'Healthcare/get_stunt_list',
            'data': function(data) {
                data.date = date,
    ...
    $('#stunt_tb tbody').on('click', 'td.details-control', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data.logstatus =='success'){
                ...
                setTimeout(
                    function() {
                        window.location = BASE_URL + "Healthcare/view_stund";
                    }, 
                2000);
