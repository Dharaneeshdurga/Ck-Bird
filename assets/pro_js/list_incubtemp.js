...
function get_incubtemp_list(date,incub){
    //$('#hide_pdate').hide();
    var ct = $('#incubtemp_tb').DataTable({
        ...
        'ajax': {
            'url': BASE_URL + 'Incubtemperature/get_incubtemp_list',
            'data': function(data) {
                data.date = date,
                data.incub = incub;
    ...
    $('#incubtemp_tb tbody').on('click', 'td.details-control', function() {
